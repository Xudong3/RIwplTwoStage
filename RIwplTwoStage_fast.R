...
###uninformative
estimator_PL<-fit_PL(TwostageSRSWORSample$y, TwostageSRSWORSample$cluster, TwostageSRSWORSample$x, pars=c(truevalue[1:2], log(truevalue[3:4])))
estimator_PL

###informative sampling
estimatoris_PL<- fit_PL(TwostageSRSWORSampleis$y, TwostageSRSWORSampleis$cluster, TwostageSRSWORSampleis$x, pars=c(truevalue[1:2], log(truevalue[3:4])))
estimatoris_PL
...
#wdalpha<-function(y1,y2, g1,g2, x1,x2,alpha,beta, sigma2,tau2, pos1, pos2,sc1, sc2,n1, N1,  n2infor,N2){
#   1/SecOrdPi(pos1, pos2,sc1, sc2, n1, N1,  n2infor,N2)*
#      (dalpha(y1,y2, g1,g2, x1,x2, alpha, beta, sigma2, tau2))
#}	

#wdbeta<-function(y1,y2, g1,g2, x1,x2,alpha,beta, sigma2,tau2, pos1, pos2,sc1, sc2,n1, N1,  n2infor,N2){
#   1/SecOrdPi(pos1, pos2,sc1, sc2, n1, N1,  n2infor, N2)*
#      (dbeta(y1,y2, g1,g2, x1,x2, alpha, beta, sigma2, tau2))
#}	


#wdsigma2<-function(y1,y2, g1,g2, x1,x2,alpha, beta, sigma2,tau2, pos1, pos2,sc1, sc2, n1, N1,  n2infor,N2){
#   1/SecOrdPi(pos1, pos2,sc1, sc2, n1, N1,  n2infor,N2)*
#      (dsigma2(y1,y2, g1,g2, x1,x2, alpha, beta, sigma2, tau2))
#}	

#wdtau2<-function(y1,y2, g1,g2, x1,x2,alpha, beta,sigma2,tau2, pos1, pos2,sc1, sc2,n1, N1,  n2infor,N2) {
#   1/SecOrdPi(pos1, pos2,sc1, sc2, n1, N1,  n2infor,N2)*
...
for(i in 1:LOTS){
   ...
   rb<-fit_PL(TwostageSRSWORSample$y, TwostageSRSWORSample$cluster, TwostageSRSWORSample$x, pars=c(truevalue[1:2], log(truevalue[3:4]))) 
   ...
   rbis<-fit_PL(TwostageSRSWORSampleis$y, TwostageSRSWORSampleis$cluster, TwostageSRSWORSampleis$x,  pars=c(truevalue[1:2], log(truevalue[3:4]))) 
   ...
   PS_WPL[i, ]<- pairscore_WPL(TwostageSRSWORSample$y, TwostageSRSWORSample$cluster, TwostageSRSWORSample$x,
                               theta=c(truevalue[1:2], log(truevalue[3:4])),  TwostageSRSWORSample$ID_unit, TwostageSRSWORSample$PSU, n1, N1, n2infor=FirststageSRSWOR*n2, N2)
   ...
   PSis_WPL[i, ]<- pairscore_WPL(TwostageSRSWORSampleis$y, TwostageSRSWORSampleis$cluster,TwostageSRSWORSampleis$x,
                                 theta=c(truevalue[1:2], log(truevalue[3:4])),TwostageSRSWORSampleis$ID_unit, TwostageSRSWORSampleis$PSU, n1, N1,  n2infor=n2is , N2)
